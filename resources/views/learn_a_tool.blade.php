<section>
    <div class="intestazione w-100 text-center">
        <h2>{{$series_learn_a_tool['category']}}</h2>
        <p>{{$series_learn_a_tool['subtitle']}}</p>
    </div>

    <div class="container-misto w-75 m-auto d-flex flex-wrap">
        <div id="series_learn_a_tool" class="singolo w-100 d-flex">
            @foreach ($series_learn_a_tool['cards'] as $card)
        ...
        <div id="series_tool_2" class="container-singolo col-4 d-flex">
